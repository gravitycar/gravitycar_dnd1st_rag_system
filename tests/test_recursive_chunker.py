...
from chunkers.recursive_chunker import (
    HeadingParser,
    Heading,
    ChunkBuilder,
    SpecialCaseRegistry,
...
class TestChunkBuilder:
    ...
    def test_default_chunking_level_2_and_3(self):
        ...
        h3 = Heading(level=3, text="Subsection", line_number=2, hierarchy=["Section", "Subsection"])
        assert builder.should_create_chunk(h3) is True
        
        # Level 4 should NOT create chunk
        h4 = Heading(level=4, text="Subsubsection", line_number=3, hierarchy=["Section", "Subsection", "Subsubsection"])
    ...
    def test_spell_chunking_level_5(self):
        ...
        h5 = Heading(
            ...
            text="Bless",
            line_number=100,
            hierarchy=["SPELL EXPLANATIONS", "CLERIC SPELLS", "First Level Spells", "Bless"]
        )
...
"""
        ...
        try:
            chunker = RecursiveChunker(temp_md, temp_json, max_chunk_size=2000, report=False)
